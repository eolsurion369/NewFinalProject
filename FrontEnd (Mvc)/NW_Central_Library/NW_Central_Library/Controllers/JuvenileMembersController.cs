...
namespace NW_Central_Library.Controllers
{
    public class JuvenileMembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AdultId,FirstName,LastName,MidInit,Suffix,Birthdate,PrimaryPhone,EmailAddress")] JuvenileMember juvenileMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AdultId,FirstName,LastName,MidInit,Suffix,Birthdate,PrimaryPhone,EmailAddress")] JuvenileMember juvenileMember)
        {
