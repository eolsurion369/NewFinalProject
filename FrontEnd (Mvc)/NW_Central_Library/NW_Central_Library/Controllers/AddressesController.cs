...
namespace NW_Central_Library.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AddrLn1,AddrLn2,City,State,Zip")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AddrLn1,AddrLn2,City,State,Zip")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
